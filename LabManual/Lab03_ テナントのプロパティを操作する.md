...
2. 左側のナビゲーション メニューで「概要」を展開し「プロパティ」タブ を選択します。

3. 「 概要|プロパティ」ブレードで、項目に、次の情報を入力して「保存」を選択します。
...
1. 同じく、「概要|プロパティ」ブレードで、次の情報を入力して「保存」を選択します。
...
1. 画面右上にある `admin@XXXXXXXXXXX.onmicrosoft.com` の名前をクリックします。
