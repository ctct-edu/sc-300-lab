...
15. 「ユーザーの一覧を追加する」ウィンドウで「ユーザー情報を含むCSVをアップロードする」に☑チェックを入れます。
...
25. 「パスワードがリセットされました」と表示されます。

    > 参考：サンプルユーザーの読み方
    >
    > 　　　Allan Deyoung　アラン・ディヤング 
    >
    > 　　　Delia Dennis　デリア・デニス 
    >
    > 　　　Alex Wilber　アレックス・ウィルバー 
    >
    > 　　　Bianca Pisani　ビアンカ・ピサーニ 
    >
    > 　　　Raul Razo　ラウル・レッツォ 
    >
    > 　　　Adele Vance　アデル・ヴァンス 
    >
    > 　　　Grady Archie　グレイディ・アーチャー 
    >
    > 　　　Miriam Graham　ミリアム・グラハム 
    >
    > 　　　Debra Berger　デブラ・バーガー 
    >
    > 　　　Chris Green　クリス・グリーン 　(Lab01で作成しますので、現時点は存在しません。)
    >
    > 　　　Adam Johnson　アダム・ジョンソン　(Lab09で作成しますので、現時点では存在しません)
...
1. 「レビューと割り当て」をクリックし、続けて「割り当て」をクリックします。

1. 一覧上に「ctcXXXX」が表示されれば、完了です。
