...
4. 「IDを検証」画面が出た場合は、admin@XXXXXXXXXXX.onmicrosoft.com のOutlookの画面にあくせすすると「Salesforceで ID を確認」という件名のメールに書かれた「確認コード」（6桁の数字）を以下画面の確認コード欄に記入し「検証」をクリックします。

5. ![aad-sso-053](./media/aad-sso-054.BMP)

6. Salesforceの画面が表示されました。これでEntraIDユーザーを使用してSalesforceにSSOすることが可能になります。
