...
### タスク 4 -エンタープライズアプリケーションでSalesforceを登録する。

Azure ADをクラウドアプリケーションと連携する場合、エンタープライズアプリケーションで登録を行います。

1. Webブラウザを開き、「[Microsoft Entra ID](https://entra.microsoft.com/) 」へアクセスします。
...
3. 左側のナビゲーション メニューの「エンタープライズアプリ」をクリックします。
...
1. 「Salesforce | SAML ベースのサインオン」を再び表示します。
