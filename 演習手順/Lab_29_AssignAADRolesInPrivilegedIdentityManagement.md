---
lab:
    title: '29 - PIMで Azure AD ロールを割り当てる'
    learning path: '04'
    module: 'モジュール 03 - 特権アクセスの計画と実装を行う'
---

# ラボ 29: PIMで Azure AD ロールを割り当てる
...
1. ****
    ...
    グローバル管理者アカウントを使用して、[https://portal.azure.com](https://portal.azure.com) にサインインします。
...
1. 「メンバーの選択」ウィンドウで、**Chris Green**を選択してから、**「選択」** を選択します。
...
2. 新しい InPrivate ブラウザー ウィンドウを開きます。

3. https://portal.azure.com に接続します。
...
8. **Chris Green**のプロファイルを選択します。 これにより、Miriam のプロフィール ページが開きます。
